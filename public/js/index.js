...
var viewBtn = function viewBtn(cell, formatterParams, onRendered) {
  //plain text value
  return '<button type="button" class="btn btn-sm btn-primary">Details</button>';
};

var deleteBtn = function deleteBtn(cell, formatterParams, onRendered) {
  //plain text value
...
var app = new Vue({
  ...
  methods: {
    onDelete: function onDelete(data) {
      ...
      var inst = this;
      axios.post("/returns/".concat(data.id)).then(function (response) {
    ...
    initializeTabulator: function initializeTabulator() {
      var ins = this;
      var isAllowedToDelete = this.isAllowed();
  ...
  mounted: function mounted() {
    ...
    setInterval(function () {
      if (_this.table != null) {
        _this.table.setData().then(getCUrrentTime);
      }
    }, 1500000);
  }
});
